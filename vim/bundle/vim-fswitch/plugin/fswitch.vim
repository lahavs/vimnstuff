...
augroup fswitch_au_group
    ...
    au BufEnter *.tpp  call s:SetVariables('hpp,h',   'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    ...
    au BufEnter *.h    call s:SetVariables('c,cpp,tpp', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
    au BufEnter *.hh   call s:SetVariables('cc',      'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
    au BufEnter *.hpp  call s:SetVariables('cpp,tpp', 'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
