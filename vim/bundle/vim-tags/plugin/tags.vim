...
if g:vim_tags_use_language_field
  let g:vim_tags_project_tags_command = substitute(g:vim_tags_project_tags_command, "{OPTIONS}", '--c++-kinds=+p --fields=+liaS --extras=+q {OPTIONS}', "")
  let g:vim_tags_gems_tags_command = substitute(g:vim_tags_gems_tags_command, "{OPTIONS}", '--c++-kinds=+p --fields=+liaS --extras=+q {OPTIONS}', "")
endif
