...
function! s:textobject(inner) abort
  ...
  " NOTE: Changed, since otherwise empty lines between "comments paragraphs"
  "         are not treated as separators between the paragraphs (i.e.
  "         [un]commenting would include ALL these paragraphs).
  "       It sucks
  " PREV: for [index, dir, bound, line] in [[0, -1, 1, ''], [1, 1, line('$'), '']]
  for [index, dir, bound, line] in [[0, -1, 1, getline('.')], [1, 1, line('$'), getline('.')]]
    " PREV: while lnums[index] != bound && line ==# '' || !(stridx(line,l) || line[strlen(line)-strlen(r) : -1] != r)
